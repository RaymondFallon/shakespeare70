...
[
    ...
    [s70_bt, actor, "The Doctor's Dilemma", 'Louis Dubedat'],
    [s70_bt, actor, 'Hamlet', 'Rosencrantz'],
    [s70_bt, director, 'Hedda Gabler'],
    [s70_bt, actor, 'Becky Shaw', 'Max Garrett'],
    [s70_bt, actor, "The Winter's Tale", "Shepherd's Son"],
    [s70_bt, lights, "The Winter's Tale"],
    [s70_bt, actor, 'Much Ado About Nothing', 'Conrad'],
    [s70_bt, actor, 'As You Like It', 'Silvius'],
    [s70_bt, actor, "A Midsummer Night's Dream", 'Peter Quince'],
    [s70_bt, actor, 'Twelfth Night', 'Sir Andrew Aguecheek'],
    [s70_bt, actor, 'The Tempest', 'Sebastian'],
    [s70_bt, actor, 'The Importance of Being Earnest', 'Gribsby'],
    [s70_bt, actor, 'A View from the Bridge', 'Mike/Immigration Officer'],
    [s70_bt, sm, 'A View from the Bridge'],
    [s70_bt, actor, 'Romeo and Juliet', "Sampson/Apothecary/Paris's Page"],
    [s70_bt, actor, 'The Skin of Our Teeth', 'Mr. Fitzpatrick'],
    [s70_bt, sm, 'The Skin of Our Teeth']

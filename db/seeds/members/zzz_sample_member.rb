...
#
# [
#     [s70_bt, position, 'TITLE_OF_PLAY', 'NAME_OF_ROLE'],
#     [s70_bt, position, 'TITLE_OF_PLAY', 'NAME_OF_ROLE'],
#     [s70_bt, position, 'TITLE_OF_PLAY', 'NAME_OF_ROLE'],
#     [s70_bt, position, 'TITLE_OF_PLAY', 'NAME_OF_ROLE'],
#     [s70_bt, position, 'TITLE_OF_PLAY', 'NAME_OF_ROLE'],
...
#
# [
#     [s70_bt, position, 'TITLE_OF_PLAY', 2099, 'NAME_OF_ROLE'],
#     [s70_bt, position, 'TITLE_OF_PLAY', 2099, 'NAME_OF_ROLE'],
#     [s70_bt, position, 'TITLE_OF_PLAY', 2099, 'NAME_OF_ROLE'],
#     [s70_bt, position, 'TITLE_OF_PLAY', 2099, 'NAME_OF_ROLE'],
#     [s70_bt, position, 'TITLE_OF_PLAY', 2099, 'NAME_OF_ROLE'],
...
# ].each do |casting|
#   Casting.where(member: say_my_name_say_my_name,
#                 production: Production.where(company: s70, title: casting[2], year: casting[3]).first_or_create!,
#                 position: casting[1],
#                 bio_type: casting[0]).first_or_create!(role: casting[4])
# end
#
# [

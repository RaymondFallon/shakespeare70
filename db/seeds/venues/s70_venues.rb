...
Venue.where(name: 'Kelsey Theatre')
    .first_or_create!(street_address: '1200 Old Trenton Road',
                      town: 'West Windsor',
                      state: 'NJ',
                      zipcode: '08550',
...
Venue.where(name: 'Open Arts PAC')
    .first_or_create!(street_address: '146 Route 130',
...
Venue.where(name: 'West Windsor Arts Center')
    .first_or_create!(street_address: '952 Alexander Road',
...
Venue.where(name: 'The Park')
    .first_or_create!(street_address: '455 Pennington Road',
                      town: 'Titusville',
                      state: 'NJ',
                      zipcode: '08560',

...
var map = {
	"./dm1_controller.js": "./app/javascript/controllers/dm1_controller.js",
	"./line_learner_controller.js": "./app/javascript/controllers/line_learner_controller.js"
};
...
/***/ "./app/javascript/controllers/dm1_controller.js":
/*!******************************************************!*\
  !*** ./app/javascript/controllers/dm1_controller.js ***!
  \******************************************************/
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    key: "printNextLetter",
    value: function printNextLetter() {
      event.preventDefault();
      event.stopPropagation();
      this.outputTarget.innerHTML += this.speech()[this.currentIndex()];
      this.incrementIndex();
      var controller = this;
      this.charTargets.some(function (character) {
        if (parseInt(character.dataset.lineIndex) < controller.currentIndex()) {
          return false;
        } else if (character.innerText.trim() === controller.myChar()) {
          return true;
        } else {
          controller.printLine(character);
        }
      });
    }
  }, {
    key: "myNextLine",
    value: function myNextLine() {
      return document.getElementById("line-number-".concat(this.currentIndex() + 1));
    }
  }, {
    key: "currentIndex",
    ...
    key: "printLine",
    value: function printLine(character) {
      var output = "<p><strong>".concat(character.innerHTML, "</strong></br>").concat(character.nextElementSibling.innerText, "</p>");
...
_default.targets = ['input', 'output', 'char', 'line'];
...
/***/ "./app/javascript/controllers/line_learner_controller.js":
/*!***************************************************************!*\
  !*** ./app/javascript/controllers/line_learner_controller.js ***!
  \***************************************************************/
/*! exports provided: default */
...
function (_Controller) {
  ...
  _createClass(_default, [{
    ...
    value: function readLine() {
      console.log('hiii');
      var myLine = this.myNextLine();
      debugger;
    }
  }, {
    key: "myChar",
    value: function myChar() {
      return 'Josh';
    }
  }, {
    key: "myNextLine",
    ...
    key: "charOptions",
    value: function charOptions() {
      var duplicate_list = this.charTargets.map(function (element) {
        return element.innerText.trim();
      });
      return duplicate_list.filter(function (item, index) {
        return duplicate_list.indexOf(item) === index;
      });
    }
  }]);
...
/******/ });
//# sourceMappingURL=application-06988ec2e921904c89e8.js.map
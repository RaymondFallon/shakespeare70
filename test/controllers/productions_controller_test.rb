...
class ProductionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create production" do
    assert_difference('Production.count') do
      post productions_url, params: { production: { end_date: @production.end_date, start_date: @production.start_date, title: @production.title } }
    end
  ...
  test "should update production" do
    patch production_url(@production), params: { production: { end_date: @production.end_date, start_date: @production.start_date, title: @production.title } }
